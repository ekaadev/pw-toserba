...
<head>
    ...
    <title>Tabel Retur Penjualan</title>
</head>
<body class="bg-light">
    <div id="db-wrapper">
        ...
        <div id="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row min-vh-80 h-100 px-5 py-5">
                    <p class="fs-2 pb-3">Tabel Retur Penjualan</p>
                    ...
                    <div class="row rounded-2 bg-white shadow-sm border fs-5 px-5">
                        <form action="viewReturPenjualan.php" method="get">
    ...
    <script src="../assets/js/returPenjualan.js"></script>
